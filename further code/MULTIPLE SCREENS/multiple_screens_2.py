...
#https://github.com/sachinbhoi29/GUI_for_python_programs/blob/master/Tk.py

import tkinter as tk # change for python 3
import tkinter.simpledialog # change for python 3
import tkinter.messagebox # change for python 3
...
def data_load_all_proj():
	var0 = tkinter.simpledialog.askstring("Data Load","Please enter the month and year(mm-yyyy): ")
	tkinter.messagebox.showinfo("Message", "Please place the master file in specific folder")
	var1 = tkinter.simpledialog.askstring("Data Load","Do you want to start loading master data? ")
	tkinter.messagebox.showinfo("Message", "Please place the files in specific folder")
	var2 = tkinter.simpledialog.askstring("Data Load","Do you want to start loading data? (Y/N): ")
	tkinter.messagebox.showinfo("Message", "Please wait while the data is loading")
...
def generate_qr_code():
	var0 = tkinter.simpledialog.askstring("QR IRN Generate","Please enter the Invoice month and year(mm-yyyy): ")
	tkinter.messagebox.showinfo("Message", "Please wait while the QR IRN is generating")
...
def generate_report():
	var0 = tkinter.simpledialog.askstring("Generate Invoice","Please enter the Invoice month and year(mm-yyyy): ")
	tkinter.messagebox.showinfo("Message", "Please wait while the Invoice is gettting generated")
...
def freeze_data():
	var0 = tkinter.simpledialog.askstring("Freeze data","Please enter the Invoice month and year(mm-yyyy): ")
	tkinter.messagebox.showinfo("Message", "Please wait while the data is being freezed")
...
def delete_data():
	var0 = tkinter.simpledialog.askstring("Delete data","Please enter the Invoice month and year(mm-yyyy): ")
	tkinter.messagebox.showinfo("Message", "Please wait while the data is being deleted")
...
def generate_revenue_report():
	var0 = tkinter.simpledialog.askstring("Delete data","Please enter the Invoice month and year(mm-yyyy): ")
	tkinter.messagebox.showinfo("Message", "Please wait while the MIS Revenue Report is being generated")
