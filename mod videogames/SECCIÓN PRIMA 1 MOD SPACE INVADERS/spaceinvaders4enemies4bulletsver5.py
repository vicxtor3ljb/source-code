...
while running:
    ...
    # Bullet firing
    if keys[pygame.K_a]:  # Red bullet
        bullet_color = colors["red"]
    elif keys[pygame.K_s]:  # Green bullet
        bullet_color = colors["green"]
    elif keys[pygame.K_d]:  # Blue bullet
        bullet_color = colors["blue"]
    elif keys[pygame.K_f]:  # Yellow bullet
    ...
    if len(enemies) < 4:
        ...
        enemy_color = random.choice(list(colors.values()))
